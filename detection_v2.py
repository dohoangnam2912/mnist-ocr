...
def detect_and_predict_text(image_path, model):
    ...
    for line_start, line_end in lines:
        ...
        for word_start, word_end in words:
            ...
            # Display the word_image for debugging and confirmation
            plt.figure()
            plt.imshow(word_image, cmap='gray')
            plt.title(f'Word Image {word_counter}')
            plt.axis('off')
            plt.show()
            ...
            # Display the preprocessed roi image to visualize exactly what is fed into the model
            plt.figure()
            plt.imshow(roi.squeeze(), cmap='gray')
            plt.title(f'Preprocessed Image {word_counter} fed to Model')
            plt.axis('off')
            plt.show()
